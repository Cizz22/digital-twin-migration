...
class EfficiencyDataDetailRootCauseAction(db.Model, BaseModel, TimestampMixin, metaclass=MetaBaseModel):
    ...
    action_id = Column(UUID(as_uuid=True), ForeignKey('hl_ms_excel_variables_cause_actions.id',
    ...
    root_cause = relationship("EfficiencyDataDetailRootCause", back_populates="actions", lazy="joined")
